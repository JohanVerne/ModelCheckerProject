...
|----------|----------------------|------------------|-------------------|----------|
| AB1      | `(alice, bob)`      | W, CS           | Vérifiée         | Aucun   |
| AB2      | `(alice, bob, flagA, flagB)` | W, A1, B1, CS, UP/DOWN | Vérifiée | Aucun |
| AB3      | `(alice, bob, flagA, flagB)` | W, A1, B1, CS, UP/DOWN + résolution conflit | Vérifiée | État suspect détecté |
